...
ok(my ($ans, $add) = ($g->get_ns_records($g->config('example.com.'))), "get_ns_records - example.com");
...
ok(my ($ans, $add) = ($g->get_ns_records($g->config('some.example.com.'))), "get_ns_records - some.example.com");
